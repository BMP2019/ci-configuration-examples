...
|:---------------------------|:-----------------:|:----------------------------:|:--------------------------:|
| [![Build Status](https://dev.azure.com/BMP2019/ci-configuration-examples/_apis/build/status/mathworks.ci-configuration-examples)](https://dev.azure.com/BMP2019/ci-configuration-examples/_build) <br> ![Azure DevOps Coverage](https://img.shields.io/azure-devops/coverage/BMP2019/ci-configuration-examples/36) | [![CircleCI](https://circleci.com/gh/BMP2019/ci-configuration-examples.svg?style=svg)](https://circleci.com/gh/mathworks/ci-configuration-examples) <br><br> | [![MATLAB](https://github.com/BMP2019/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/BMP2019/ci-configuration-examples/actions/workflows/ci.yml) <br><br> | [![Build Status](https://app.travis-ci.com/BMP2019/ci-configuration-examples.svg)](https://app.travis-ci.com/BMP2019/ci-configuration-examples) <br><br> |
##Modificado
